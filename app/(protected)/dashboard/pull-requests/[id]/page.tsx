...
import { PrDiffViewer } from "@/features/reviews/components/pr-diff-viewer";
      ...
      <div className="flex flex-col gap-6 px-6 pb-6">
        {pr.status === "reviewed" && pr.reviewComment ? (
          <div className="grid gap-6 grid-cols-1 lg:grid-cols-4">
            ...
            {/* AI Code Review Report Content - Extended to 3 columns */}
            <div className="lg:col-span-3">
              <PrDiffViewer prId={pr.id} reviewComment={pr.reviewComment} />
            </div>
          </div>
        ) : (
